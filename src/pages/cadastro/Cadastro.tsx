      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
        ...
        >
          ...
          <div className="flex justify-around w-full gap-8">
            <button onClick={retornar} className="rounded text-white bg-red-400 hover:bg-red-700 w-1/2 py-2">
              Cancelar
            </button>
            <button
              className="flex justify-center rounded text-white bg-indigo-400 hover:bg-indigo-900 w-1/2 py-2"
              type="submit"
            >
              {isLoading ? (
                <RotatingLines
